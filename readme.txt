...
Yes, it actually works. Waste Spammers' time. Make Them helpless.
...
Why do Spammers go through the trouble of cloaking their links? In truth, they are scared you’d discover “why”: 1. fear of termination by Ad Networks, and/or 2. fear of penalties by Google.
...
1. Unzip the spammers-suck zip.
2. Upload the `spammer-suck` folder (the folder itself, NOT it's contents) to the `/wp-content/plugins` directory.
